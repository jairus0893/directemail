...
?>
                ...
                <form name="exclusionuploadcsv" id="exclusionuploadcsv" >
                <?=$iswin;?>
                <title>Upload Exclusion List</title>
                <div id="respmessage"></div>
                
                <div><label>Campaign:</label>
                <?=$selproject;?></div>
                <div><label>Exclusion ListId: </label><input type="text" id="exclusionlistid" name="exclusionlistid" /></div>
