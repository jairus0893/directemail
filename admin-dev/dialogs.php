...
<div class="entryform" id="objs" style="width:300px;">
 ...
 <div><label>Name:</label><input type="text" name="fieldname" id="fieldname" /><br>(Internal Name)</div>
  ...
  <div>
  <div id="img_dialog" title="Existing Default Fields" style="display:none"><img src="maininformation.PNG" alt="Existing Fields" /></div>  
     <a href="#" id="img_dialog_link" style="text-decoration: underline;" onclick="openimg();"><i>*Existing Default Fields</i></a>
     <br/>
     <input type="button" value="add" onclick="addcf('<?php echo $_REQUEST['pid'];?>')" />
</div>
...
?>
    ...
    <tr><td width="339" class="center-title">Type</td><td class="dataleft datas"><select name="statustype" id="statustype"  style="font-size:10px" onchange="statusoptions()">
            ...
            <option value="externalpost">External Post</option>
