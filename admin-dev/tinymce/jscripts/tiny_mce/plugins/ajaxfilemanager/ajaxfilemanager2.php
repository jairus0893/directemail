...
<title>Dashboard: <?php include_once('../../../../../config.php');
	$s = "select * from settings";
	$q = mysql_query($s);
	$f = mysql_fetch_array($q);
	echo $f['s_name'];?></title>
<script type="text/javascript" src="jscripts/ajaxfilemanager_c.js"></script>
<!--<script type='text/javascript' src='../../../../../auto-complete/jquery/jquery-1.4.2.js'></script>
...
<div style="padding: 25px 0 15px; min-height: 60px; background:#transparent;">
	...
	<div style="wrapper">
		...
		<div id="callInfo" style="margin-right: 160px;">
			<span>Howdy, <b><font color="green"><?php
			include_once('../../../../../config.php');
			$current_user = $_SESSION['user'];
			$a = "select * from admin where username = '$current_user'";
			$b = mysql_query($a);
			$c = mysql_fetch_array($b);
			echo $current_user; ?></font></b></span>
		</div>
		...
		<div id="navigation" style="margin-right: 120px;">
 			<div id="menu" class="dropdown">
            <ul id="nav" class="dropdown">
			<li><a href="../../../../../dashboard.php">Dashboard</a></li>
            <li><a href="../../../../../pages.php">Pages</a></li>
			<li><a href="../../../../../news.php" class="current">News & Events</a></li>
              <?php 
					$user = $_SESSION['user'];
					$sql = "select * from admin where username = '$user'";
					$res = mysql_query($sql);
					$f = mysql_fetch_array($res);
			  ?>
   			  <?php if($f['role'] == "administrator"){ ?>
             <li><a href="../../../../../users.php">Accounts</a>
			 <ul class="sub-menu">
             ...
             <?php if($f['role'] == "administrator"){ ?>
			  <li><a href="../../../../../set.php">Settings</a>
			  <ul class="sub-menu">
					<li><a href="ajaxfilemanager2.php" class="selected">Manage Image</a></li>
			  </ul>
			  <li>
...
<div class="frameShadow frameTop"><img src="../../../../../images/back_frame_top.png" height="10" width="980" alt="" /></div>
<div id="frame">  
    <div style="padding:0 10px; padding-bottom:10px;" align="left">
  		<dl id="currentFolderInfo" style="padding-top:10px;">
...
<form action="" method="POST" name="formAction" id="formAction"><input type="hidden" name="currentFolderPath" id="currentFolderPathVal" value="" /><select name="selectedDoc[]" id="selectedDoc" style="display:none;" multiple="multiple"></select><input type="hidden" name="action_value" value="" id="action_value" /></form>				
    ...
    <div id="">
      ...
      <div id="rightCol" style="color:#0033FF;">
	      	<?php
			if(CONFIG_LOAD_DOC_LATTER )
			{
      ...
      <div id="leftCol" style="background:#fff;">
      


				<fieldset id="folderFieldSet" style="background:#fff;">
			...
			<fieldset id="fileFieldSet" style="background:#fff;">
        ...
        <p class="searchButtons" id="returnCurrentUrl">
      	...
      	<fieldset class="boxSearch"  style="background:#fff;">
        ...
        <p align="left">
        	<span>
        		<input type="button" value="<?php echo BTN_SEARCH; ?>" onclick="return search();" class="button2">
        	</span>
