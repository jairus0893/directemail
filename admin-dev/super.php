...
include "superadmin/super-include.php";
$act = $_REQUEST['act'];
...
if ($_REQUEST['act'] == 'disable')
{
    $bcid = $_REQUEST['bcid'];
    mysql_query("UPDATE bc_clients set status = 'Inactive' where bcid = '$bcid'");
}
if ($_REQUEST['act'] == 'enable')
{
    $bcid = $_REQUEST['bcid'];
    mysql_query("UPDATE bc_clients set status = 'Active' where bcid = '$bcid'");
}
if ($_REQUEST['act'] == 'deactivated')
{
    $bcid = $_REQUEST['bcid'];
    mysql_query("UPDATE bc_clients set status = 'Deactivated' where bcid = '$bcid'");
}
...
<body>
<? include("superadmin/superscripts-include.php") ?>
<div id="container">
...
if (isset($_REQUEST['inactive'])) {
    ...
    $toginactive = true;
	$togdeactivated = false;
} else if (isset($_REQUEST['deactivated'])) {
    $bclist = getbclist('Deactivated');
    $togdeactivated = true;
	$toginactive = false;
} else {
