...
if ($act == 'customreport') {
    ...
    $customreportres = mysql_query("SELECT * FROM uiopt WHERE project_id = '$projectid' AND config = 'CustomReport' ORDER BY ts DESC LIMIT 1");
...
function updatelist()
	{
        ...
        $.ajax({
  		    url: "campperformance.php?act=customreport&pid="+proj,
  		    success: function(resp){
                if (resp != "false") {
                    window.location = "customreport/"+resp+"?pid="+proj;
                } else {
                    $.ajax({
...
function listrep()
{
	...
	$.ajax({
  		...
  		url: "campperformance.php?act=listview&type=list",
  		data: {
  			"projectid": proj,
  			"listid": listid
  		},
    ...
    if (dateretr == false)
        {
  		...
  		url: "campperformance.php?act=view&view=bydate",
  		data: {
  			"projectid": proj,
  			"listid": listid,
  			"start": start,
...
function viewrepagent()
{
	...
	$.ajax({
  		...
  		url: "campperformance.php?act=view&view=byagent",
  		data: {
  			"projectid": proj,
  			"listid": listid,
  			"start": start,
...
function viewrep()
{
	...
	$.ajax({
  		...
  		url: "campperformance.php?act=summary",
  		data: {
  			"projectid": proj,
  			"listid": listid,
  			"start": start,
...
function exportrep()
{
	...
	var ff = $("#filterform").serialize();
  	var url = "campperformance.php?act=view&"+ff+"&type=export&view="+currenttab;
	window.open(url);
...
function showgraph(date)
{
	...
	$.ajax({
  		...
  		url: "campperformance.php?act=view&type=graph&view=bydate",
  		data: {
  			"projectid": proj,
  			"listid": listid,
  			"date": date
...
function showgraphagent(userid)
{
	...
	$.ajax({
  		...
  		url: "campperformance.php?act=view&type=graph&view=byagent",
  		data: {
  			"projectid": proj,
  			"listid": listid,
  			"date": userid,
