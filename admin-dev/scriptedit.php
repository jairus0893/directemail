        ...
        <div id="inputfields">
            ...
            <ul id="inmenu" class="domenu">
                ...
                <li>
                    ...
                    <a href="#" draggable="true" ondragstart="dragstart(event)" ondragend="fieldparams('text')" onclick="fieldparams('text','<?php echo $scriptid; ?>')">Textfield</a>

                </li>

                <li>

                    <a href="#" draggable="true" ondragstart="dragstart(event)" ondragend="fieldparams('select')" onclick="fieldparams('select','<?php echo $scriptid; ?>')">Dropdown</a>
